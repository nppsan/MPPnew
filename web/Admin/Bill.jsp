                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div style="float:right; display:inline"  id="sel_cust" class="col-sm-11">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="card-title"><label class="control-label mb-10 text-left"> select client for billing</label></div><hr>
                                        <div id="div-tb">
                                            <div id="div-btn"></div>
                                            <table id="tb21" class ='table table-striped' style='display: block; margin: auto; 
                                                   padding: 5px 5px 5px 5px; width:30%; text-align: center; '>
                            ...
                            <form style="display: none;" id="form1" action="../AddCustDetailsServlet" method="POST"> 
                                ...
                                <div style=" display:inline"  class="col-sm-11">
                                    ...
                                    <div class="form-group row" style="margin: auto">
                                        ...
                                        <div class="col-sm-11">
                                            <button type="button" id="btn1" onclick="showForm2()" class="btn btn-primary shadow-primary px-5"><i class="icon-lock"></i>NEXT</button>
                                        </div>
                                    </div>
			   </div>
                            ...
                            <form style="display: none;" id="form3" action="../AddCustDetailsServlet" method="POST"> 
                                ...
                                <div class="card" style="width:125%; margin-bottom:10%; margin-left: 10%">
                                    <div class="card-body">
                                        <div class="card-title">SELECT PRODUCTS</div>
                                        <hr>
                                        <div class="form-group row">
                                            <label for="input-10" class="col-sm-2 col-form-label">SELECT</label>

                                            <div class="col-sm-4" >
                                                <select style="width: 65%"onchange="getproduct()" class="form-control" id="productselect">
                                                    <option>                                       </option>
                                                    <%
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div id="output1" >
                                                <div class="col-sm-4">
                                                    <input style="width: auto; margin: auto" type="text" class="form-control" value="0.0" id="prate" readonly="readonly" name="rate">
                                                </div>
                                            </div>    
                                            <label for="input-11"  style="margin-left: auto;" class="col-sm-2 col-form-label">CGST(%)</label>
                                            <div class="col-sm-4">
                                                <input style="width: auto; " type="text" class="form-control" id="input-11" readonly="readonly" value="9" name="cgst">
                                            </div>
                                            <div class="col-sm-4">
                                                <!--<input style="width: auto;" type="text" class="form-control" id="sac"  value="2536446" name="sac">-->
                                            </div>
                                            <label for="input-11"  style="margin-left: auto;" class="col-sm-2 col-form-label"></label>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-4">
                                                <input style="width: auto; margin-bottom: 13px;" type="text" class="form-control" id="input-12" readonly="readonly" value="9" name="sgst">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="input-10" class="col-sm-2 col-form-label" >Discount(%)</label>
                                            <div class="col-sm-4">
                                                <input style="width: auto;"  type="text" class="form-control" autocomplete="off" id="disco" onkeyup="calc()" value="0.0" name="discount">
                                            </div>
                                            <label for="input-11" class="col-sm-2 col-form-label">IGST(%)</label>
                                            <div class="col-sm-4">
                                                <input  style="width: auto;" type="text" class="form-control" id="input-13" readonly="readonly" value="0" name="igst">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="input-10" class="col-sm-2 col-form-label">Amount</label>
                                            <div class="col-sm-4">
                                                <input  style="width: auto;" type="text" class="form-control" id="amt"  value="0.0" name="amt">
                                            </div>
                                            <label for="input-11" class="col-sm-2 col-form-label" >Quantity/ Sq.Mt.</label>
                                            <div class="col-sm-4">
                                                <input  style="width: auto;" type="text" class="form-control" autocomplete="off" id="quant" onkeyup="calc1()" value="1.0" name="quantity">
                                            </div>
                                        </div>
