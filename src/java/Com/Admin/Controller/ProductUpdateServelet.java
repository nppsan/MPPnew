 ...
 * @author npp
 */
@WebServlet(name = "ProductUpdateServelet", urlPatterns = {"/ProductUpdateServelet"})
public class ProductUpdateServelet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            pm.setType(Category);
            pm.setPsize(Psize);
            pm.setRate(Float.parseFloat(Prate));
            pm.setCatid(Long.parseLong(cid) );
            pm.setId(Long.parseLong(id) );
